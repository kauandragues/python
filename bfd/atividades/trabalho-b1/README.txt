Sistema de Biblioteca - Trabalho 1º Bimestre
...
4-Execute o arquivo biblioteca.py na pasta trabalho 

OBS:Todos os arquivos csv serão salvos na mesma pasta do arquivo biblioteca.py 

Exemplos de Uso no README.pdf
...
def salvar_dados():
  ...
  try:
    with open("livros.csv", "w",newline="") as arquivo_livros:
      ...
      escritor.writerow(["idLivro", "titulo", "ISBN", "ano", "nomeEditora", "nomeAutor","status"]) #cabeçalho
  ...
  try:
    with open("usuarios.csv", "w",newline="") as arquivo_usuarios:
      ...
      escritor.writerow(["matriculaUsuario", "nome", "email"]) #cabeçalho
  ...
  try:
    with open("emprestimos.csv", "w",newline="") as arquivo_emprestimos:
      ...
      escritor.writerow(["idEmprestimo","dataRetirada","dataDevolucaoPrevista","dataDevolucaoReal","status","idLivro","matriculaUsuario"]) #cabeçalho
...
def cadastrar_livro():
  ...
  novo_livro = [len(livros)+1,titulo,isbn,ano,editora,autor,status]#id autoincremetal, cria uma registro novo de livro
...
def cadastrar_usuario():
  ...
  novo_usuario = [len(usuarios)+1,nome,email]#matricula autoincremetal, cria uma registro novo de usuário
...
def registrar_emprestimo():
  ...
  data_devolucao = data_retirada + timedelta(days=7) #somar 7 dias no dia de hoje

  data_retirada_string = data_retirada.strftime("%d-%m-%Y") #transformar em string
  data_devolucao_string = data_devolucao.strftime("%d-%m-%Y") #transformar em string
  ...
  novo_emprestimo = [len(emprestimos)+1,data_retirada_string,data_devolucao_string,data_devolucao_real,status,id_livro, matricula_usuario]#id autoincremetal, cria uma registro novo de emprestimo
...
def registrar_devolucao():
  ...
  # -----------------------------
  try:
    id_emprestimo = int(input("Digite o id do emprestimo (digite um número inteiro):"))
  except ValueError:
    print("Você não digitou um número inteiro!")
  ...
  for emprestimo in emprestimos[::-1]:#pega a lista de emprestimo do mais recente primeiro
    if int(emprestimo[0]) == id_emprestimo and emprestimo[3] == '':

      for livro in livros:
        if int(emprestimo[5]) == int(livro[0]):#pega o titulo do livro emprestado
          print(f"O livro a ser devolvido é {livro[1]}")

      for usuario in usuarios:
        if int(emprestimo[6]) == int(usuario[0]):#mostra as informações do usuário que emprestou o livro
...
def listar_livros_disponiveis():
  ...
  for livro in livros:
    if livro[6] == "Disponível":
      print(f"{livro[0]:<3} | {livro[1]:<20} | {livro[2]:<20} | {livro[3]:<4} | {livro[4]:<20} | {livro[5]:<20}")
  print("-----------------------------------------------------------------------------------------------------")
        ...
        if int(livro[0]) == int(emprestimo[5]):
          for usuario in usuarios:
            if int(usuario[0]) == int(emprestimo[6]):
              print(f"{emprestimo[0]:<3} | {emprestimo[1]:<10} | {emprestimo[2]:<10} | {emprestimo[4]:<15} | {emprestimo[5]:<9} | {livro[1]:<20} | {emprestimo[6]:<15} | {usuario[1]:<15}")
  print("--------------------------------------------------------------------------------------------------------------------------------")
    ...
    if emprestimo[3] != '':
      for livro in livros:
        if int(livro[0]) == int(emprestimo[5]):
          for usuario in usuarios:
            if int(usuario[0]) == int(emprestimo[6]):
              print(f"{emprestimo[0]:<3} | {emprestimo[1]:<10} | {emprestimo[2]:<10} | {emprestimo[3]:<10} | {emprestimo[4]:<15} | {emprestimo[5]:<9} | {livro[1]:<20} | {emprestimo[6]:<15} | {usuario[1]:<15}")
  print("--------------------------------------------------------------------------------------------------------------------------------")
...
def atualizar_status_emprestimo():
  ...
  for emprestimo in emprestimos:
    ...
    data_prevista_date = datetime.strptime(data_prevista,"%d-%m-%Y").date()
...
def buscar_livro_por_ano():
  ...
  # -----------------------------
  try:
    busca_ano_livro = int(input("Digite o ano do livro (digite um número inteiro):"))
  except ValueError:
    print("Você não digitou um número inteiro!")
    return
  ...
  for livro in livros:
    if int(livro[3]) == busca_ano_livro:
      print(f"{livro[0]:<3} | {livro[1]:<20} | {livro[2]:<20} | {livro[3]:<4} | {livro[4]:<20} | {livro[5]:<20} | {livro[6]:<10}")
  print("---------------------------------------------------------------------------------------------------------------")
